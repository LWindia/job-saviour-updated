...
const posts = [
 
  {
    ...
    author: {
      ...
      avatar: "/assets/Akansha chaurasia.jpg",
  ...
  },
  {
    ...
    author: {
      ...
      avatar: "https://media.licdn.com/dms/image/v2/D5603AQHwV5jPANJh3g/profile-displayphoto-crop_800_800/B56Zs0TqM1IEAI-/0/1766109129106?e=1768435200&v=beta&t=ZdQG4ukpHvKZAv4QNTCpbv5Afd0dfTopopeZ8M1JE9c",
  ...
  },
  {
    ...
    author: {
      ...
      avatar: "/assets/Dibyaraj Datta.jpg",
  ...
  },
  {
    ...
    author: {
      ...
      avatar: "https://media.licdn.com/dms/image/v2/D4D03AQH9caqLtsFOKw/profile-displayphoto-shrink_800_800/B4DZPdW6uqGkAc-/0/1734585593402?e=1768435200&v=beta&t=gMSzvccJLM9mazqJP8SR3xS67tyFGJ2p9U3EtN9HSJU",
  ...
  },
  {
    ...
    author: {
      ...
      avatar: "/assets/Himanshu Sahu.jpg",
  ...
  },
  {
    ...
    author: {
      ...
      avatar: "https://media.licdn.com/dms/image/v2/D4D03AQHspredHFM_Ig/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1729926571953?e=1768435200&v=beta&t=2pLilmnRYh6U5RqRmUbd2EqWCRz-h9aYm1QrufLPggQ",
...
const PostCard: React.FC<{ post: any }> = ({ post }) => {
  ...
  const hasValidAvatar = post.author.avatar && post.author.avatar.trim() !== '';

  return (
    <div className="bg-[#ffffff] text-black mt-4 shadow-md w-full p-4 rounded-lg">
      <div className="pb-2">
        <div className="flex items-center space-x-3 sm:space-x-4">
          <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-gray-300 flex items-center justify-center overflow-hidden relative flex-shrink-0">
            {hasValidAvatar && (
              <img
                src={encodeURI(post.author.avatar)}
                alt={post.author.name}
                className="h-full w-full object-cover rounded-full"
                onError={(e) => {
                  console.log('Image failed to load:', post.author.name, 'Path:', post.author.avatar);
                  setImageError(true);
                }}
                onLoad={() => {
                  console.log('Image loaded successfully:', post.author.name);
                  setImageLoaded(true);
                  setImageError(false);
                }}
                loading="eager"
            ...
            {imageError && (
              <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-red-500 to-red-700 text-white font-semibold text-xs sm:text-sm absolute inset-0 z-10">
                {getInitials(post.author.name)}
              </div>
            )}
            {!hasValidAvatar && (
              <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-red-500 to-red-700 text-white font-semibold text-xs sm:text-sm">
                {getInitials(post.author.name)}
              </div>
            )}
          </div>
