          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2 cursor-pointer px-4 py-2 rounded-md border-2 border-gray-300 hover:border-[#ff0000] transition-all flex-1 bg-white">
                  <input
                    type="radio"
                    name="currentStatus"
                    value="student"
              ...
              {errors.currentStatus && <p className="text-red-600 text-sm mt-1">{errors.currentStatus}</p>}
            </div>

            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 bg-[#ff0000] text-white rounded-lg hover:bg-red-700 font-semibold text-base mt-6 transition-colors"
            >
