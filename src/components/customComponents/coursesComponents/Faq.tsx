  ...
  curriculum: [
    ...
    },
    {
      question: "What is the job guarantee??",
       answer: "We guarantee that every eligible Placement Guarantee initiative student will secure a placement (full-time employment or an internship with a pre-placement offer) within 12 months after graduating from the Placement Guarantee initiative program."
    },
    {
      question: "What is the salary I will get an offer for?",
      answer: "Entry-level DevOps roles typically offer salaries ranging from ₹4 LPA to ₹8 LPA per year, depending on location, industry, and level of expertise. For 2024 pass-out students, the applicable salary is ₹3 LPA."
    },
    {
...
(
  ...
  <li>Training in building your projects & presenting effectively to recruiters.
...

    {
      ...
      answer:
"Entry-level DevOps roles typically offer salaries ranging from ₹4 LPA to ₹8 LPA per year, depending on location, industry, and level of expertise. For 2024 pass-out students, the applicable salary is ₹3 LPA."
    },
  ],
  selectionCriteria: [
    {
