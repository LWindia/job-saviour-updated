...
export const modules: Module[] = [
  ...
  },
  {
    "id": 15,
    "title": "Module 15",
    "subtitle": "ELK Stack (Elasticsearch, Logstash, Kibana)",
    "topics": [
      {
        "id": 210,
        "title": "Elasticsearch Overview",
        "content": [
          "Architecture of Elasticsearch clusters (Nodes, Clusters, Scalability & High Availability).",
          "Index Management (Indices, Shards & Replicas for performance and redundancy).",
          "Querying Data with Elasticsearch Query DSL (Match queries, Filters & Aggregations).",
          "Efficient log searching and analytics using distributed indexing."
        ]
      },
      {
        "id": 211,
        "title": "Logstash Overview",
        "content": [
          "Logstash Architecture and Pipeline Concepts (Input, Filter, Output).",
          "Configuring Logstash pipelines for log ingestion and transformation.",
          "Using filters for log parsing and enrichment (Grok, Mutate, Date).",
          "Enriching logs using plugins like GeoIP and DNS."
        ]
      },
      {
        "id": 212,
        ...
        "content": [
          "Introduction to Kibana for data visualization and analysis.",
          "Creating dashboards for logs, errors, and user activity insights.",
          "Configuring visualizations (Charts, Tables, Maps).",
          "Setting up alerts and monitoring insights using Kibana."
        ]
      }
    ]
  },
  {
    ...
    "topics": [
      {
        "id": 213,
        "title": "Static Code Analysis Overview",
        "content": [
          "Concept of static code analysis and its importance in DevSecOps.",
          "Role of SonarQube in maintaining code quality and security."
        ]
      },
      {
        "id": 214,
        "title": "SonarQube Setup & Configuration",
        "content": [
          "Installing and configuring SonarQube server and scanner.",
          "Configuring quality profiles and quality gates.",
          "Analyzing code coverage, technical debt, bugs, and code smells."
        ]
      },
      {
        "id": 215,
        ...
        "content": [
          "Integrating SonarQube with build tools (Maven, Gradle).",
          "CI/CD integration with Jenkins, GitLab CI/CD, and GitHub Actions.",
          "Generating reports and actionable insights for developers."
        ]
      }
    ]
  },
  {
    "id": 17,
    "title": "Module 17",
    "subtitle": "Snyk for Vulnerability Scanning",
    "topics": [
      {
        "id": 216,
        "title": "Introduction to Snyk",
        "content": [
          "Overview of software vulnerabilities and security risks.",
          "Features of Snyk for scanning code, dependencies, containers, and IaC."
        ]
      },
      {
        "id": 217,
        ...
        "content": [
          "Setting up Snyk CLI and dashboard.",
      ...
      {
        "id": 218,
        "title": "Container & IaC Security",
        "content": [
          "Scanning container images for vulnerabilities.",
          "Analyzing Terraform and Kubernetes YAML files for misconfigurations."
        ]
      },
      {
        "id": 219,
        "title": "Snyk CI/CD Integration",
        "content": [
          "Automating security scans in Jenkins, GitHub Actions, and GitLab CI/CD.",
          "Generating real-time alerts and vulnerability reports."
        ]
      }
    ]
  }
