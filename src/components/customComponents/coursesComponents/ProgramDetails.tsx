...
import { GraduationCap, Briefcase, Code, Check } from 'lucide-react'
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <h3 className="text-md sm:text-lg text-black font-semibold">
                LW Job Oriented DevOps Globally Recognized Initiative 2026
              </h3>
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                ...
                <p className="text-sm text-black">
                  Open to all technical students pursuing B.Tech, BCA, MCA, M.Tech, or B.Sc IT — 2024, 2025, and 2026 pass-outs.
                </p>
              </div>
              <div className="flex gap-3">
              ...
              <div className="flex gap-3">
                ...
                <p className="text-sm text-black">
                  90% completion and timely submission of assignments and live projects
                </p>
              </div>
              <div className="flex gap-3">
                <Check className="w-5 h-5 text-red-500 flex-shrink-0" />
                <p className="text-sm text-black">
                  90% participation in assessments, including:
                </p>
              </div>
            </div>
          </Card>
