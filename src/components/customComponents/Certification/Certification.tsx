  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        ...
        Industry Recognised & Approved <span className="text-[#ff0000]"> Job Oriented Specialisation </span> in DevOps Program Certificates
        </h1>
          ...
          <div className="w-full md:w-1/2">
            <div className="space-y-6">
              <h2 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
               ...
               Specialisation in DevOps Training Certificate
              </h2>
                ...
                <CardContent className="p-0"> 
                  <div className="relative group">
                    <div className="relative w-full h-[400px] w-[300px]">
                      <Image
                        src="/assets/Certificate/Certificate.jpeg"
