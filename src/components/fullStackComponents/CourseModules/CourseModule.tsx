...
export default function CourseCurriculumModule() {
  ...
  return (
    <div className="pt-4 md:pt-0 w-full pb-0 relative bg-gradient-to-br from-gray-50 via-black-50 to-red-50" id="trainingcontent">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="hidden md:block max-w-6xl px-2 md:px-8 mx-auto py-6 text-3xl font-bold text-center">
          Let's walk you through the journey of <span className="text-[#ff0000]"> <br/>Placement Guaranteed Full Stack Development</span> Initiative by LinuxWorld
        </div>
    ...
    <div className="absolute top-0 right-0 hidden md:block">
      ...
      >
       <CalendarDays className="mr-2 mt-4 mb-4   h-6"/>  6 Months Training + 6 Months Placement Support
      </Badge>
  ...
  >
    <CalendarDays className=" mt-4 mb-4 h-6"/> &nbsp; 6 Months Training + 6 Months Placement Support
  </Badge>
</div>
